...
public class VerifyPinServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (pin == null || pin.isEmpty() || amountStr == null || amountStr.isEmpty() || type == null || type.isEmpty()) {
            System.out.println("ERROR: Missing PIN, amount, or transaction type.");
            response.sendRedirect("enterpin.html?error=missing_data");
            return;
        }
